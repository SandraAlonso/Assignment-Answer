...
class Blast_functions 
    ...
    def search_orthologs(organism1, organism2)
        ...
        org2.each do |entry|    # Iteration of the sequence in search
            ...
            if query_org_2.hits.length != 0 && query_org_2.hits[0].evalue <= (10**-6) && query_org_2.hits[0].overlap >= 50      #Conditions for the hit to be considered a good one: threshole below 10^⁻6 and overlapover 50%
                ...
                if query_org_1.hits.length != 0 && query_org_1.hits[0].evalue <= (10**-6) && query_org_1.hits[0].overlap >= 50  #Conditions for the hit to be considered a good one: threshole below 10^⁻6 and overlapover 50%
